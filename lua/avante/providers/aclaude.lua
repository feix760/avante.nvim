...
local device_id = "9d1c250a-e61b-44d9-88ed-0000"
local account_uuid = "9d1c250a-e61b-44d9-88ed-9999"
local claude_code_spoof_prompt = "You are Claude Code, Anthropic's official CLI for Claude."

M.api_key_name = "IDEALAB_CLAUDE_API_KEY"
...
function M:parse_curl_args(prompt_opts)
  ...
  local headers = {
    ...
    ["x-app"] = "cli",
    ["x-claude-code-session-id"] = chat_id,
